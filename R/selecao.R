...
#' @param CID a CID code. isso e codigo CID de interesse. Suporta expressoes regulares. Para selecao de mais de um codigo e necessario separar por Barras.CID = Codificacao Internacional de Doencas
